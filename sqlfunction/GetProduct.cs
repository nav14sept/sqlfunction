...
namespace sqlfunction
{
    public static class GetProduct
    {
        ...
        {
            string connectionString = "Server=navsqlserve.database.windows.net,1433;Initial Catalog=AZ204-APP;Persist Security Info=False;User ID=nav14sept;Password=naveen@14;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
